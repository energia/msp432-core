...
#define ti_sysbios_family_arm_msp432_Seconds___VERS 160
...
typedef xdc_Bool (*CT__ti_sysbios_family_arm_msp432_Seconds_Module__startupDoneFxn)(void);
__extern __FAR__ const CT__ti_sysbios_family_arm_msp432_Seconds_Module__startupDoneFxn ti_sysbios_family_arm_msp432_Seconds_Module__startupDoneFxn__C;
...
typedef __ARRAY1_ti_sysbios_family_arm_msp432_Seconds_daysPerMonthNonLeap __TA_ti_sysbios_family_arm_msp432_Seconds_daysPerMonthNonLeap;
typedef __TA_ti_sysbios_family_arm_msp432_Seconds_daysPerMonthNonLeap CT__ti_sysbios_family_arm_msp432_Seconds_daysPerMonthNonLeap;
...
typedef __ARRAY1_ti_sysbios_family_arm_msp432_Seconds_daysPerMonthLeap __TA_ti_sysbios_family_arm_msp432_Seconds_daysPerMonthLeap;
typedef __TA_ti_sysbios_family_arm_msp432_Seconds_daysPerMonthLeap CT__ti_sysbios_family_arm_msp432_Seconds_daysPerMonthLeap;
...
{
    return ti_sysbios_family_arm_msp432_Seconds_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sysbios_family_arm_msp432_Seconds_Module_getMask( void ) 
{
    return ti_sysbios_family_arm_msp432_Seconds_Module__diagsMask__C != NULL ? *ti_sysbios_family_arm_msp432_Seconds_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sysbios_family_arm_msp432_Seconds_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sysbios_family_arm_msp432_Seconds_Module__diagsMask__C != NULL) *ti_sysbios_family_arm_msp432_Seconds_Module__diagsMask__C = mask;
}
