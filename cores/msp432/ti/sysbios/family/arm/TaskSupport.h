...
#define ti_sysbios_family_arm_TaskSupport_getCheckValueAddr ti_sysbios_family_arm_TaskSupport_getCheckValueAddr__E
xdc__CODESECT(ti_sysbios_family_arm_TaskSupport_getCheckValueAddr__E, "ti_sysbios_family_arm_TaskSupport_getCheckValueAddr")
__extern xdc_Ptr ti_sysbios_family_arm_TaskSupport_getCheckValueAddr__E( xdc_Ptr curTask );
...
#define TaskSupport_getCheckValueAddr ti_sysbios_family_arm_TaskSupport_getCheckValueAddr
