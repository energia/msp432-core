...
#define xdc_runtime_LoggerSys_TimestampProxy___VERS 160
...
/* Object__create__S */
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Object__create__S, "xdc_runtime_LoggerSys_TimestampProxy_Object__create__S")
...
/* Object__delete__S */
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Object__delete__S, "xdc_runtime_LoggerSys_TimestampProxy_Object__delete__S")
__extern xdc_Void xdc_runtime_LoggerSys_TimestampProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_LoggerSys_TimestampProxy_Object__destruct__S, "xdc_runtime_LoggerSys_TimestampProxy_Object__destruct__S")
