...
#ifdef xdc_rom_build
#define xdc_runtime_Startup_Module__diagsEnabled__C (constPtr->xdc_runtime_Startup_Module__diagsEnabled__C)
#define xdc_runtime_Startup_Module__diagsIncluded__C (constPtr->xdc_runtime_Startup_Module__diagsIncluded__C)
#define xdc_runtime_Startup_Module__diagsMask__C (constPtr->xdc_runtime_Startup_Module__diagsMask__C)
#define xdc_runtime_Startup_Module__gateObj__C (constPtr->xdc_runtime_Startup_Module__gateObj__C)
#define xdc_runtime_Startup_Module__gatePrms__C (constPtr->xdc_runtime_Startup_Module__gatePrms__C)
#define xdc_runtime_Startup_Module__id__C (constPtr->xdc_runtime_Startup_Module__id__C)
#define xdc_runtime_Startup_Module__loggerDefined__C (constPtr->xdc_runtime_Startup_Module__loggerDefined__C)
#define xdc_runtime_Startup_Module__loggerObj__C (constPtr->xdc_runtime_Startup_Module__loggerObj__C)
#define xdc_runtime_Startup_Module__loggerFxn0__C (constPtr->xdc_runtime_Startup_Module__loggerFxn0__C)
#define xdc_runtime_Startup_Module__loggerFxn1__C (constPtr->xdc_runtime_Startup_Module__loggerFxn1__C)
#define xdc_runtime_Startup_Module__loggerFxn2__C (constPtr->xdc_runtime_Startup_Module__loggerFxn2__C)
#define xdc_runtime_Startup_Module__loggerFxn4__C (constPtr->xdc_runtime_Startup_Module__loggerFxn4__C)
#define xdc_runtime_Startup_Module__loggerFxn8__C (constPtr->xdc_runtime_Startup_Module__loggerFxn8__C)
#define xdc_runtime_Startup_Module__startupDoneFxn__C (constPtr->xdc_runtime_Startup_Module__startupDoneFxn__C)
#define xdc_runtime_Startup_Object__count__C (constPtr->xdc_runtime_Startup_Object__count__C)
#define xdc_runtime_Startup_Object__heap__C (constPtr->xdc_runtime_Startup_Object__heap__C)
#define xdc_runtime_Startup_Object__sizeof__C (constPtr->xdc_runtime_Startup_Object__sizeof__C)
#define xdc_runtime_Startup_Object__table__C (constPtr->xdc_runtime_Startup_Object__table__C)
#define xdc_runtime_Startup_maxPasses__C (constPtr->xdc_runtime_Startup_maxPasses__C)
#define xdc_runtime_Startup_firstFxns__C (constPtr->xdc_runtime_Startup_firstFxns__C)
#define xdc_runtime_Startup_lastFxns__C (constPtr->xdc_runtime_Startup_lastFxns__C)
#define xdc_runtime_Startup_startModsFxn__C (constPtr->xdc_runtime_Startup_startModsFxn__C)
#define xdc_runtime_Startup_execImpl__C (constPtr->xdc_runtime_Startup_execImpl__C)
#define xdc_runtime_Startup_sfxnTab__C (constPtr->xdc_runtime_Startup_sfxnTab__C)
#define xdc_runtime_Startup_sfxnRts__C (constPtr->xdc_runtime_Startup_sfxnRts__C)
#endif
/*
