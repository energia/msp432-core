...
#define xdc_runtime_GateNull___VERS 160
...
__extern xdc_Void xdc_runtime_GateNull_Instance_init__E(xdc_runtime_GateNull_Object *, const xdc_runtime_GateNull_Params *);
...
__extern xdc_runtime_GateNull_Handle xdc_runtime_GateNull_create( const xdc_runtime_GateNull_Params *__prms, xdc_runtime_Error_Block *__eb );

/* construct */
xdc__CODESECT(xdc_runtime_GateNull_construct, "xdc_runtime_GateNull_construct")
__extern void xdc_runtime_GateNull_construct( xdc_runtime_GateNull_Struct *__obj, const xdc_runtime_GateNull_Params *__prms );
...
/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_GateNull_Object__destruct__S, "xdc_runtime_GateNull_Object__destruct__S")
...
#ifdef xdc_rom_build
#define xdc_runtime_GateNull_Module__diagsEnabled__C (constPtr->xdc_runtime_GateNull_Module__diagsEnabled__C)
#define xdc_runtime_GateNull_Module__diagsIncluded__C (constPtr->xdc_runtime_GateNull_Module__diagsIncluded__C)
#define xdc_runtime_GateNull_Module__diagsMask__C (constPtr->xdc_runtime_GateNull_Module__diagsMask__C)
#define xdc_runtime_GateNull_Module__gateObj__C (constPtr->xdc_runtime_GateNull_Module__gateObj__C)
#define xdc_runtime_GateNull_Module__gatePrms__C (constPtr->xdc_runtime_GateNull_Module__gatePrms__C)
#define xdc_runtime_GateNull_Module__id__C (constPtr->xdc_runtime_GateNull_Module__id__C)
#define xdc_runtime_GateNull_Module__loggerDefined__C (constPtr->xdc_runtime_GateNull_Module__loggerDefined__C)
#define xdc_runtime_GateNull_Module__loggerObj__C (constPtr->xdc_runtime_GateNull_Module__loggerObj__C)
#define xdc_runtime_GateNull_Module__loggerFxn0__C (constPtr->xdc_runtime_GateNull_Module__loggerFxn0__C)
#define xdc_runtime_GateNull_Module__loggerFxn1__C (constPtr->xdc_runtime_GateNull_Module__loggerFxn1__C)
#define xdc_runtime_GateNull_Module__loggerFxn2__C (constPtr->xdc_runtime_GateNull_Module__loggerFxn2__C)
#define xdc_runtime_GateNull_Module__loggerFxn4__C (constPtr->xdc_runtime_GateNull_Module__loggerFxn4__C)
#define xdc_runtime_GateNull_Module__loggerFxn8__C (constPtr->xdc_runtime_GateNull_Module__loggerFxn8__C)
#define xdc_runtime_GateNull_Module__startupDoneFxn__C (constPtr->xdc_runtime_GateNull_Module__startupDoneFxn__C)
#define xdc_runtime_GateNull_Object__count__C (constPtr->xdc_runtime_GateNull_Object__count__C)
#define xdc_runtime_GateNull_Object__heap__C (constPtr->xdc_runtime_GateNull_Object__heap__C)
#define xdc_runtime_GateNull_Object__sizeof__C (constPtr->xdc_runtime_GateNull_Object__sizeof__C)
#define xdc_runtime_GateNull_Object__table__C (constPtr->xdc_runtime_GateNull_Object__table__C)
#endif
/*
