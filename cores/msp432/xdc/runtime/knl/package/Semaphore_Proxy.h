...
#define xdc_runtime_knl_Semaphore_Proxy___VERS 160
...
/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Proxy_Object__create__S, "xdc_runtime_knl_Semaphore_Proxy_Object__create__S")
...
/* create */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Proxy_create, "xdc_runtime_knl_Semaphore_Proxy_create")
__extern xdc_runtime_knl_Semaphore_Proxy_Handle xdc_runtime_knl_Semaphore_Proxy_create( const xdc_runtime_knl_Semaphore_Proxy_Params *__prms, xdc_runtime_Error_Block *__eb );

/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Proxy_Object__delete__S, "xdc_runtime_knl_Semaphore_Proxy_Object__delete__S")
__extern xdc_Void xdc_runtime_knl_Semaphore_Proxy_Object__delete__S( xdc_Ptr instp );

/* delete */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Proxy_delete, "xdc_runtime_knl_Semaphore_Proxy_delete")
__extern void xdc_runtime_knl_Semaphore_Proxy_delete(xdc_runtime_knl_Semaphore_Proxy_Handle *instp);

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Proxy_Object__destruct__S, "xdc_runtime_knl_Semaphore_Proxy_Object__destruct__S")
