...
#define xdc_runtime_knl_SyncSemThread___VERS 160
...
__extern xdc_Int xdc_runtime_knl_SyncSemThread_Instance_init__E(xdc_runtime_knl_SyncSemThread_Object *, const xdc_runtime_knl_SyncSemThread_Params *, xdc_runtime_Error_Block *);

/* Instance_finalize__E */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Instance_finalize__E, "xdc_runtime_knl_SyncSemThread_Instance_finalize")
__extern void xdc_runtime_knl_SyncSemThread_Instance_finalize__E( xdc_runtime_knl_SyncSemThread_Object* , int );
...
__extern xdc_runtime_knl_SyncSemThread_Handle xdc_runtime_knl_SyncSemThread_create( const xdc_runtime_knl_SyncSemThread_Params *__prms, xdc_runtime_Error_Block *__eb );

/* construct */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_construct, "xdc_runtime_knl_SyncSemThread_construct")
__extern void xdc_runtime_knl_SyncSemThread_construct( xdc_runtime_knl_SyncSemThread_Struct *__obj, const xdc_runtime_knl_SyncSemThread_Params *__prms, xdc_runtime_Error_Block *__eb );
...
/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Object__destruct__S, "xdc_runtime_knl_SyncSemThread_Object__destruct__S")
...
#ifdef xdc_rom_build
#define xdc_runtime_knl_SyncSemThread_Module__diagsEnabled__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__diagsEnabled__C)
#define xdc_runtime_knl_SyncSemThread_Module__diagsIncluded__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__diagsIncluded__C)
#define xdc_runtime_knl_SyncSemThread_Module__diagsMask__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__diagsMask__C)
#define xdc_runtime_knl_SyncSemThread_Module__gateObj__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__gateObj__C)
#define xdc_runtime_knl_SyncSemThread_Module__gatePrms__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__gatePrms__C)
#define xdc_runtime_knl_SyncSemThread_Module__id__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__id__C)
#define xdc_runtime_knl_SyncSemThread_Module__loggerDefined__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__loggerDefined__C)
#define xdc_runtime_knl_SyncSemThread_Module__loggerObj__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__loggerObj__C)
#define xdc_runtime_knl_SyncSemThread_Module__loggerFxn0__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__loggerFxn0__C)
#define xdc_runtime_knl_SyncSemThread_Module__loggerFxn1__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__loggerFxn1__C)
#define xdc_runtime_knl_SyncSemThread_Module__loggerFxn2__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__loggerFxn2__C)
#define xdc_runtime_knl_SyncSemThread_Module__loggerFxn4__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__loggerFxn4__C)
#define xdc_runtime_knl_SyncSemThread_Module__loggerFxn8__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__loggerFxn8__C)
#define xdc_runtime_knl_SyncSemThread_Module__startupDoneFxn__C (constPtr->xdc_runtime_knl_SyncSemThread_Module__startupDoneFxn__C)
#define xdc_runtime_knl_SyncSemThread_Object__count__C (constPtr->xdc_runtime_knl_SyncSemThread_Object__count__C)
#define xdc_runtime_knl_SyncSemThread_Object__heap__C (constPtr->xdc_runtime_knl_SyncSemThread_Object__heap__C)
#define xdc_runtime_knl_SyncSemThread_Object__sizeof__C (constPtr->xdc_runtime_knl_SyncSemThread_Object__sizeof__C)
#define xdc_runtime_knl_SyncSemThread_Object__table__C (constPtr->xdc_runtime_knl_SyncSemThread_Object__table__C)
#endif
/*
