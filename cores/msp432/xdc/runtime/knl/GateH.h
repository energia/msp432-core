...
#ifdef xdc_rom_build
#define xdc_runtime_knl_GateH_Module__diagsEnabled__C (constPtr->xdc_runtime_knl_GateH_Module__diagsEnabled__C)
#define xdc_runtime_knl_GateH_Module__diagsIncluded__C (constPtr->xdc_runtime_knl_GateH_Module__diagsIncluded__C)
#define xdc_runtime_knl_GateH_Module__diagsMask__C (constPtr->xdc_runtime_knl_GateH_Module__diagsMask__C)
#define xdc_runtime_knl_GateH_Module__gateObj__C (constPtr->xdc_runtime_knl_GateH_Module__gateObj__C)
#define xdc_runtime_knl_GateH_Module__gatePrms__C (constPtr->xdc_runtime_knl_GateH_Module__gatePrms__C)
#define xdc_runtime_knl_GateH_Module__id__C (constPtr->xdc_runtime_knl_GateH_Module__id__C)
#define xdc_runtime_knl_GateH_Module__loggerDefined__C (constPtr->xdc_runtime_knl_GateH_Module__loggerDefined__C)
#define xdc_runtime_knl_GateH_Module__loggerObj__C (constPtr->xdc_runtime_knl_GateH_Module__loggerObj__C)
#define xdc_runtime_knl_GateH_Module__loggerFxn0__C (constPtr->xdc_runtime_knl_GateH_Module__loggerFxn0__C)
#define xdc_runtime_knl_GateH_Module__loggerFxn1__C (constPtr->xdc_runtime_knl_GateH_Module__loggerFxn1__C)
#define xdc_runtime_knl_GateH_Module__loggerFxn2__C (constPtr->xdc_runtime_knl_GateH_Module__loggerFxn2__C)
#define xdc_runtime_knl_GateH_Module__loggerFxn4__C (constPtr->xdc_runtime_knl_GateH_Module__loggerFxn4__C)
#define xdc_runtime_knl_GateH_Module__loggerFxn8__C (constPtr->xdc_runtime_knl_GateH_Module__loggerFxn8__C)
#define xdc_runtime_knl_GateH_Module__startupDoneFxn__C (constPtr->xdc_runtime_knl_GateH_Module__startupDoneFxn__C)
#define xdc_runtime_knl_GateH_Object__count__C (constPtr->xdc_runtime_knl_GateH_Object__count__C)
#define xdc_runtime_knl_GateH_Object__heap__C (constPtr->xdc_runtime_knl_GateH_Object__heap__C)
#define xdc_runtime_knl_GateH_Object__sizeof__C (constPtr->xdc_runtime_knl_GateH_Object__sizeof__C)
#define xdc_runtime_knl_GateH_Object__table__C (constPtr->xdc_runtime_knl_GateH_Object__table__C)
#endif
/*
