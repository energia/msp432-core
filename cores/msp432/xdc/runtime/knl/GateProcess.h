...
#define xdc_runtime_knl_GateProcess___VERS 160
...
__extern xdc_Int xdc_runtime_knl_GateProcess_Instance_init__E(xdc_runtime_knl_GateProcess_Object *, const xdc_runtime_knl_GateProcess_Params *, xdc_runtime_Error_Block *);

/* Instance_finalize__E */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Instance_finalize__E, "xdc_runtime_knl_GateProcess_Instance_finalize")
__extern void xdc_runtime_knl_GateProcess_Instance_finalize__E( xdc_runtime_knl_GateProcess_Object* , int );
...
__extern xdc_runtime_knl_GateProcess_Handle xdc_runtime_knl_GateProcess_create( const xdc_runtime_knl_GateProcess_Params *__prms, xdc_runtime_Error_Block *__eb );

/* construct */
xdc__CODESECT(xdc_runtime_knl_GateProcess_construct, "xdc_runtime_knl_GateProcess_construct")
__extern void xdc_runtime_knl_GateProcess_construct( xdc_runtime_knl_GateProcess_Struct *__obj, const xdc_runtime_knl_GateProcess_Params *__prms, xdc_runtime_Error_Block *__eb );
...
#ifdef xdc_rom_build
#define xdc_runtime_knl_GateProcess_Module__diagsEnabled__C (constPtr->xdc_runtime_knl_GateProcess_Module__diagsEnabled__C)
#define xdc_runtime_knl_GateProcess_Module__diagsIncluded__C (constPtr->xdc_runtime_knl_GateProcess_Module__diagsIncluded__C)
#define xdc_runtime_knl_GateProcess_Module__diagsMask__C (constPtr->xdc_runtime_knl_GateProcess_Module__diagsMask__C)
#define xdc_runtime_knl_GateProcess_Module__gateObj__C (constPtr->xdc_runtime_knl_GateProcess_Module__gateObj__C)
#define xdc_runtime_knl_GateProcess_Module__gatePrms__C (constPtr->xdc_runtime_knl_GateProcess_Module__gatePrms__C)
#define xdc_runtime_knl_GateProcess_Module__id__C (constPtr->xdc_runtime_knl_GateProcess_Module__id__C)
#define xdc_runtime_knl_GateProcess_Module__loggerDefined__C (constPtr->xdc_runtime_knl_GateProcess_Module__loggerDefined__C)
#define xdc_runtime_knl_GateProcess_Module__loggerObj__C (constPtr->xdc_runtime_knl_GateProcess_Module__loggerObj__C)
#define xdc_runtime_knl_GateProcess_Module__loggerFxn0__C (constPtr->xdc_runtime_knl_GateProcess_Module__loggerFxn0__C)
#define xdc_runtime_knl_GateProcess_Module__loggerFxn1__C (constPtr->xdc_runtime_knl_GateProcess_Module__loggerFxn1__C)
#define xdc_runtime_knl_GateProcess_Module__loggerFxn2__C (constPtr->xdc_runtime_knl_GateProcess_Module__loggerFxn2__C)
#define xdc_runtime_knl_GateProcess_Module__loggerFxn4__C (constPtr->xdc_runtime_knl_GateProcess_Module__loggerFxn4__C)
#define xdc_runtime_knl_GateProcess_Module__loggerFxn8__C (constPtr->xdc_runtime_knl_GateProcess_Module__loggerFxn8__C)
#define xdc_runtime_knl_GateProcess_Module__startupDoneFxn__C (constPtr->xdc_runtime_knl_GateProcess_Module__startupDoneFxn__C)
#define xdc_runtime_knl_GateProcess_Object__count__C (constPtr->xdc_runtime_knl_GateProcess_Object__count__C)
#define xdc_runtime_knl_GateProcess_Object__heap__C (constPtr->xdc_runtime_knl_GateProcess_Object__heap__C)
#define xdc_runtime_knl_GateProcess_Object__sizeof__C (constPtr->xdc_runtime_knl_GateProcess_Object__sizeof__C)
#define xdc_runtime_knl_GateProcess_Object__table__C (constPtr->xdc_runtime_knl_GateProcess_Object__table__C)
#define xdc_runtime_knl_GateProcess_A_invalidKey__C (constPtr->xdc_runtime_knl_GateProcess_A_invalidKey__C)
#endif
/*
 *  @(#) xdc.runtime.knl; 1, 0, 0,0; 2-11-2016 17:29:59; /db/ztree/library/trees/xdc/xdc-B09/src/packages/
 */
