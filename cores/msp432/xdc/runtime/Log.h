...
#ifdef xdc_rom_build
#define xdc_runtime_Log_Module__diagsEnabled__C (constPtr->xdc_runtime_Log_Module__diagsEnabled__C)
#define xdc_runtime_Log_Module__diagsIncluded__C (constPtr->xdc_runtime_Log_Module__diagsIncluded__C)
#define xdc_runtime_Log_Module__diagsMask__C (constPtr->xdc_runtime_Log_Module__diagsMask__C)
#define xdc_runtime_Log_Module__gateObj__C (constPtr->xdc_runtime_Log_Module__gateObj__C)
#define xdc_runtime_Log_Module__gatePrms__C (constPtr->xdc_runtime_Log_Module__gatePrms__C)
#define xdc_runtime_Log_Module__id__C (constPtr->xdc_runtime_Log_Module__id__C)
#define xdc_runtime_Log_Module__loggerDefined__C (constPtr->xdc_runtime_Log_Module__loggerDefined__C)
#define xdc_runtime_Log_Module__loggerObj__C (constPtr->xdc_runtime_Log_Module__loggerObj__C)
#define xdc_runtime_Log_Module__loggerFxn0__C (constPtr->xdc_runtime_Log_Module__loggerFxn0__C)
#define xdc_runtime_Log_Module__loggerFxn1__C (constPtr->xdc_runtime_Log_Module__loggerFxn1__C)
#define xdc_runtime_Log_Module__loggerFxn2__C (constPtr->xdc_runtime_Log_Module__loggerFxn2__C)
#define xdc_runtime_Log_Module__loggerFxn4__C (constPtr->xdc_runtime_Log_Module__loggerFxn4__C)
#define xdc_runtime_Log_Module__loggerFxn8__C (constPtr->xdc_runtime_Log_Module__loggerFxn8__C)
#define xdc_runtime_Log_Module__startupDoneFxn__C (constPtr->xdc_runtime_Log_Module__startupDoneFxn__C)
#define xdc_runtime_Log_Object__count__C (constPtr->xdc_runtime_Log_Object__count__C)
#define xdc_runtime_Log_Object__heap__C (constPtr->xdc_runtime_Log_Object__heap__C)
#define xdc_runtime_Log_Object__sizeof__C (constPtr->xdc_runtime_Log_Object__sizeof__C)
#define xdc_runtime_Log_Object__table__C (constPtr->xdc_runtime_Log_Object__table__C)
#define xdc_runtime_Log_L_construct__C (constPtr->xdc_runtime_Log_L_construct__C)
#define xdc_runtime_Log_L_create__C (constPtr->xdc_runtime_Log_L_create__C)
#define xdc_runtime_Log_L_destruct__C (constPtr->xdc_runtime_Log_L_destruct__C)
#define xdc_runtime_Log_L_delete__C (constPtr->xdc_runtime_Log_L_delete__C)
#define xdc_runtime_Log_L_error__C (constPtr->xdc_runtime_Log_L_error__C)
#define xdc_runtime_Log_L_warning__C (constPtr->xdc_runtime_Log_L_warning__C)
#define xdc_runtime_Log_L_info__C (constPtr->xdc_runtime_Log_L_info__C)
#define xdc_runtime_Log_L_start__C (constPtr->xdc_runtime_Log_L_start__C)
#define xdc_runtime_Log_L_stop__C (constPtr->xdc_runtime_Log_L_stop__C)
#define xdc_runtime_Log_L_startInstance__C (constPtr->xdc_runtime_Log_L_startInstance__C)
#define xdc_runtime_Log_L_stopInstance__C (constPtr->xdc_runtime_Log_L_stopInstance__C)
#endif
/*
