 ...
 */
#define xdc_target__isaCompatible_v8A  1
...
#define  xdc_target__sizeof_Ptr 8
#define  xdc_target__sizeof_Short 2
#define  xdc_target__sizeof_Size 8
...
#define  xdc_target__alignof_Ptr 8
#define  xdc_target__alignof_Short 2
#define  xdc_target__alignof_Size 8
